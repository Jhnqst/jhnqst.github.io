...
no.addEventListener("click", () => {
  if (count == 2) {
    ...
    text.innerHTML = "Last na toooo wag na mag NO please😭";
    yes.style.height = "80%";
    yes.style.width = "80%";
    ...
    text.innerHTML = "hala yati ra ga no ghpn";
    yes.style.height = "90%";
    yes.style.width = "96%";
...
yes.addEventListener("click", () => {
  ...
  text.innerHTML = "YOWNNNNN MWA MAY KISS KA SAKEN😘";
  yes.innerHTML = '<a href="https://www.facebook.com/jhnqsaot/">Message me</a>';// inside the " " put your social media profile link
  yes.style.height = "90%";
  yes.style.width = "96%";
  no.style.display = "none";
  setTimeout(() => {
